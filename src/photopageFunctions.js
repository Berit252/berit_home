...
function changeImg01(changeId) {
    ...
    newImg.setAttribute('src', `../public/img/pack1/${calcNewImg}.jpg`)
...
function changeImg02(changeId) {
    ...
    newImg.setAttribute('src', `../public/img/pack2/${calcNewImg}.jpg`)
    newImg.setAttribute('id', 'current-img')
...
function changeImg03(changeId) {
    ...
    newImg.setAttribute('src', `../public/img/pack3/${calcNewImg}.jpg`)
    newImg.setAttribute('id', 'current-img')
